...
//---------------------------------------------------------------------------
void TDecompressingCopier::operator () (char * dest, const char * src, int & dest_size, int & src_size)
{
	...
	while (true)
	{
		...
		if (value & mask) treepos = tree[treepos * 2];

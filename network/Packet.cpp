...
//---------------------------------------------------------------------------
TPacketMegaClilocRequest::TPacketMegaClilocRequest(const vector<DWORD> &list)
: TPacket(0, true)
{
...
//---------------------------------------------------------------------------
TPacketChangeStatLockStateRequest::TPacketChangeStatLockStateRequest(BYTE stat, BYTE state)
: TPacket(7, false)
{
	Buffer = m_Buf;
	Ptr = m_Buf;

...
//---------------------------------------------------------------------------
//!Тип выбранного объекта при рендере
enum SELECT_OBJECT_TYPE
{
	SOT_NO_OBJECT = 0,		//!Ничего не выбрано
	SOT_GAME_GUMP_SCOPE,	//!Рамка игрового окна
	SOT_GAME_OBJECT,		//!Игровой объект
	SOT_STATIC_OBJECT,		//!Статика
	SOT_LAND_OBJECT,		//!Ландшафт
	SOT_TEXT_OBJECT			//!Текст
};
//---------------------------------------------------------------------------
...
enum CLIENT_VERSION
{
	...
	CV_306E,		//Добавлен пакет с типом клиента (0xBF subcmd 0x0F)
	...
	CV_500A,		//Кнопки папердолла заменены: Journal -> Quests; Chat -> Guild, использование Mega Cliloc
...
enum GUMP_OBJECT_TYPE
{
	...
	GOT_ENDGROUP,			//!Идектификатор окончания группы
	GOT_MASTERGUMP,			//!Шта?
	...
	GOT_TILEPICHUE,			//!Картинка из статики (цветная)
	GOT_GUMPPIC,			//!Картинка из гампа
	GOT_GUMPPICTILED,		//!Картинка из гампа и статики
	GOT_TEXT,				//!Текст (юникод, как и остальные тексты гампов)
	GOT_TEXTENTRY,			//!Ввод текста
	GOT_TEXTENTRYLIMITED,	//!Ограниченый ввод текста
	GOT_CROPPEDTEXT,		//!Ограниченный ввод текста (с окончанием на '...' при условии выхода из лимита)

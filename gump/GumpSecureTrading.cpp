...
int TGumpSecureTrading::Draw(bool &mode)
{
	...
	/*if (mode && GetTopObjDistance(g_Player, selobj) < 3 && IsPressed && ObjectInHand == NULL && g_LastObjectLeftMouseDown != ID_GST_CHECKBOX && ((g_MouseX != g_DroppedLeftMouseX || g_MouseY != g_DroppedLeftMouseY) || (g_LastGumpMouseDownTime + DCLICK_DELAY < g_Ticks)))
	{

...
enum GUMP_TYPE
{
	...
	GT_SKILL,				//!Гамп навыка
	GT_COMBAT_BOOK,			//!Гамп книги абилок
	GT_ABILITY,				//!Гамп абилки
	GT_RACIAL_ABILITIES_BOOK,//!Гамп книги рассовых абилок
	GT_RACIAL_ABILITY		//!Гамп рассовой абилки
};
//----------------------------------------------------------------------------------

...
enum CONFIG_VALUE_KEY
{
	...
	CVK_USE_TOOLTIPS,
	CFK_ALWAYS_RUN,
	CVK_NEW_TARGET_SYSTEM,
	CVK_OBJECT_HANDLES,
	CVK_SCALE_SPEECH_DELAY,
	CVK_SPEECH_DELAY,
	CVK_IGNORE_GUILD_MESSAGES,
	CVK_IGNORE_ALLIANCE_MESSAGES,
	CVK_DARK_NIGHTS,
	CVK_COLORED_LIGHTING,
	CVK_CRIMINAL_ACTIONS_QUERY,
	CVK_CIRCLETRANS,
	CVK_CIRCLETRANS_VALUE,
	CVK_LOCK_RESIZING_GAME_WINDOW,
	CVK_CLIENT_FPS_VALUE,
	CVK_USE_SCALING_GAME_WINDOW,
	CVK_DRAW_STATUS_STATE,
	CVK_DRAW_STUMPS,
	CVK_MARKING_CAVES,
	CVK_NO_VEGETATION,
	CVK_NO_ANIMATE_FIELDS,
	CVK_STANDARD_CHARACTERS_DELAY,
	CVK_STANDARD_ITEMS_DELAY,
	CVK_LOCK_GUMPS_MOVING,
	CVK_CONSOLE_NEED_ENTER,
	CVK_HIDDEN_CHARACTERS_MODE,
	CVK_HIDDEN_CHARACTERS_ALPHA,
	CVK_HIDDEN_CHARACTERS_MODE_ONLY_FOR_SELF,
	CFK_TRANSPARENT_SPELL_ICONS,
	CFK_SPELL_ICONS_ALPHA
};
//----------------------------------------------------------------------------------

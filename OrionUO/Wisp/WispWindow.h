...
{
	SETGET(HWND, Handle);
	SETGETE(WISP_GEOMETRY::CSize, Size, OnChangeSize);
	SETGET(bool, NoResize);
	SETGETE(WISP_GEOMETRY::CSize, MinSize, OnChangeMinSize);
	SETGETE(WISP_GEOMETRY::CSize, MaxSize, OnChangeMaxSize);

...
void CGumpScreenMain::UpdateContent()
{
	...
	text->CreateTextureA(2, g_ClilocManager.Cliloc(g_Language)->GetA(3000052, "Log in to Ultima Online"));

	text = (CGUIText*)Add(new CGUIText(0x0386, 183, 345));
	text->CreateTextureA(2, g_ClilocManager.Cliloc(g_Language)->GetA(3000039, "Account Name"));

	text = (CGUIText*)Add(new CGUIText(0x0386, 183, 385));
	text->CreateTextureA(2, g_ClilocManager.Cliloc(g_Language)->GetA(3000040, "Password"));

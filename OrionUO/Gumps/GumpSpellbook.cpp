...
{
	g_ClilocManager.Cliloc(g_Language)->GetA(1028384, "First Circle"),
	g_ClilocManager.Cliloc(g_Language)->GetA(1028385, "Second Circle"),
	g_ClilocManager.Cliloc(g_Language)->GetA(1028386, "Third Circle"),
	g_ClilocManager.Cliloc(g_Language)->GetA(1028387, "Fourth Circle"),
	g_ClilocManager.Cliloc(g_Language)->GetA(1028388, "Fifth Circle"),
	g_ClilocManager.Cliloc(g_Language)->GetA(1028389, "Sixth Circle"),
	g_ClilocManager.Cliloc(g_Language)->GetA(1028390, "Seventh Circle"),
	g_ClilocManager.Cliloc(g_Language)->GetA(1028391, "Eighth Circle")
};
//----------------------------------------------------------------------------------
...
{
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028320, "Clumsy"), "U J" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028321, "Create Food"), "I M Y" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028322, "Feeblemind"), "R W" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028323, "Heal"), "I M" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028324, "Magic Arrow"), "I P Y" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028325, "Night Sight"), "I L" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028326, "Reactive Armor"), "F S" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028327, "Weaken"), "D M" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028328, "Agility"), "E U" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028329, "Cunning"), "U W" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028330, "Cure"), "A N" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028331, "Harm"), "A M" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028332, "Magic Trap"), "I J" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028333, "Magic Untrap"), "A J" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028334, "Protection"), "U S" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028335, "Strength"), "U M" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028336, "Bless"), "R S" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028337, "Fireball"), "V F" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028338, "Magic Lock"), "A P" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028339, "Poison"), "I N" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028340, "Telekinesis"), "O P Y" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028341, "Teleport"), "R P" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028342, "Unlock"), "E P" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028343, "Wall of Stone"), "I S Y" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028344, "Arch Cure"), "V A N" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028345, "Arch Protection"), "V U S" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028346, "Curse"), "D S" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028347, "Fire Field"), "I F G" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028348, "Greater Heal"), "I V M" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028349, "Lightning"), "P O G" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028350, "Mana Drain"), "O R" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028351, "Recall"), "K O P" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028352, "Blade Spirits"), "I H J Y" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028353, "Dispel Field"), "A G" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028354, "Incognito"), "K I E" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028355, "Magic Reflection"), "I J S" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028356, "Mind Blast"), "P C W" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028357, "Paralyze"), "A E P" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028358, "Poison Field"), "I N G" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028359, "Summ. Creature"), "K X" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028360, "Dispel"), "A O" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028361, "Energy Bolt"), "C P" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028362, "Explosion"), "V O F" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028363, "Invisibility"), "A L X" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028364, "Mark"), "K P Y" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028365, "Mass Curse"), "V D S" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028366, "Paralyze Field"), "I E G" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028367, "Reveal"), "W Q" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028368, "Chain Lightning"), "V O G" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028369, "Energy Field"), "I S G" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028370, "Flame Strike"), "K V F" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028371, "Gate Travel"), "V R P" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028372, "Mana Vampire"), "O S" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028373, "Mass Dispel"), "V A O" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028374, "Meteor Swarm"), "F K D Y" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028375, "Polymorph"), "V Y R" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028376, "Earthquake"), "I V P" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028377, "Energy Vortex"), "V C P" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028378, "Resurrection"), "A C" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028379, "Air Elemental"), "K V X H" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028380, "Summon Daemon"), "K V X C" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028381, "Earth Elemental"), "K V X Y" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028382, "Fire Elemental"), "K V X F" },
	{ g_ClilocManager.Cliloc(g_Language)->GetA(1028383, "Water Elemental"), "K V X A" }
};	
//----------------------------------------------------------------------------------

...
//----------------------------------------------------------------------------------
void CDECL FUNCBODY_DrawTextA(int x, int y, unsigned char font, const char *text, unsigned short color, int width, TEXT_ALIGN_TYPE align, unsigned short flags)
{
	g_FontManager.DrawA(font, text, color, x, y, width, align, flags);
}
//----------------------------------------------------------------------------------
void CDECL FUNCBODY_DrawTextW(int x, int y, unsigned char font, const wchar_t *text, unsigned short color, int width, TEXT_ALIGN_TYPE align, unsigned short flags)
{
...
//----------------------------------------------------------------------------------
void CDECL FUNCBODY_DrawGumppic(int x, int y, unsigned short graphic, unsigned short color, int width, int height)
{

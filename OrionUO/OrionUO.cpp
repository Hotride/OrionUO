...
void COrion::CheckStaticTileFilterFiles()
{
	...
	if (!PathFileExistsA(filePath.c_str()))
	{
		...
		static const int treeTilesCount = 41;
		...
		static const ushort treeTiles[treeTilesCount] =
		{
			...
			0x0CFB, 0x0CFE, 0x0D01,	0x12B6, 0x12B7,
	...
	if (!PathFileExistsA(filePath.c_str()))
	{
		...
		static const int vegetationTilesCount = 187;
		...
		static const ushort vegetationTiles[vegetationTilesCount] =
		{
			...
			0x0C38, 0x0CBA, 0x0D2F, 0x0D32, 0x0D33, 0x0D41, 0x0D44, 0x0D57, 0x0D58, 0x0D5A,
			0x0D5B, 0x0D6E, 0x0D6F, 0x0D71, 0x0D72, 0x0D84, 0x0D86
		};

...
//---------------------------------------------------------------------------
void CBlowfishCrypt::RawEncrypt(PDWORD values, int table)
{
...
//---------------------------------------------------------------------------
void CBlowfishCrypt::Encrypt(PBYTE in, PBYTE out, int len)
{
...
//---------------------------------------------------------------------------
void CTwofishCrypt::Init(BYTE IP[4])
{
	memcpy(&m_IP, IP, 4);
...
//---------------------------------------------------------------------------
void CTwofishCrypt::Encrypt(PBYTE in, PBYTE out, int size)
{
	BYTE tmpBuff[0x100];
...
//---------------------------------------------------------------------------
void CTwofishCrypt::Decrypt(PBYTE in, PBYTE out, int size)
{
